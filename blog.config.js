...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zhongchen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a han-p', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhonghchen.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '中琛的博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/65097329?spm_id_from=333.1007.0.0', // B站主页
